...
- A new monthly-membership Billing Request takes instalment one immediately, then creates a finite subscription for only the remaining N−1 collections. Reused mandates skip the immediate payment and retain all N subscription collections.
