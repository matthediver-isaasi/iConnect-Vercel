...
geometrically contained by a Section or Box inherits that container's absolute
...
containment. Mixed nested Sections/Boxes use the smallest owner and inherit
each container displacement once; adjacent content stays independent. Editor
