---
name: Form answer lifecycle
description: Answer types, temporal validation, derived labels, and hidden-answer authority.
---

- [Row-source answer semantics](form-row-source-answer-types.md) — projected distinct values are scalars, not record references.
