...
- [Email column release gate](email-column-release-gate.md) — hybrid fallback stays test-only until received Gmail/mobile/classic Outlook checks; source CSS and browser tests are not client proof.
