...
export function createDiscountHelper(supabase) {
return { evaluateDiscountsForEntity, evaluateDiscountsForOrg, applyDiscountsToAnnualCost };
...
async function evaluateDiscountsForEntity(configId, tenantId, entityId, fieldOverrides = {}, entityType = 'organization') {
  return evaluateDiscountsInternal(configId, tenantId, entityId, fieldOverrides, entityType);
}

async function evaluateDiscountsForOrg(configId, tenantId, organizationId, fieldOverrides = {}) {
...
function applyDiscountsToAnnualCost(annualCost, discountDetails) {
