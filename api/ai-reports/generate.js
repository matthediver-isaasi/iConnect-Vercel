...
const TABLE_COLUMNS = {
  ...
  article_view: ['id', 'tenant_id', 'article_id', 'member_id', 'created_date'],
  article_comment: ['id', 'tenant_id', 'article_id', 'member_id', 'created_date'],
  article_reaction: ['id', 'tenant_id', 'article_id', 'member_id', 'reaction_type', 'created_date'],
