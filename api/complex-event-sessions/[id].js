  ...
  if (req.method === 'PATCH') {
    try {
      ...
      const ALLOWED_FIELDS = [
        ...
        , 'online_provider', 'teams_online_meeting_id', 'teams_join_web_url',
        'teams_organiser_microsoft_user_id', 'teams_organiser_email',
        'teams_outlook_connection_id', 'teams_meeting_lifecycle'
