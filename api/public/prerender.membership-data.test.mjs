  ...
  test(`${type} never renders private or state-specific content into shared prerender`, () => {
    const html = render({
      ...
      content: {
        ...
        paymentHistoryFrom: '2015-02-01',
        payment: {
          state: 'active', nextPayment: '2026-10-01', amount: 123.45, currency: 'GBP',
          mandateStatus: 'active', collectionStatus: 'confirmed',
          plannedPayment: { date: '2026-10-01', amount: 123.45, currency: 'GBP' },
          confirmedPayment: { date: '2026-10-02', amount: 123.45, currency: 'GBP' },
        },
