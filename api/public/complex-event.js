...
export default async function handler(req, res) {
  ...
  try {
    ...
    const { data: ticketClasses, error: tcError } = await supabase
      ...
      .select('id, name, price, is_free, early_bird_enabled, early_bird_price, early_bird_deadline, visibility_mode, linked_track_ids, all_tracks, display_order, is_group_ticket, group_size')
