// Admin endpoint: same flow as api/events/[id]/delete-with-cancellations.js
// but operates on the complex_event table + complex_event_booking pipeline.
// See api/_lib/eventDeletion.js for full behaviour notes (task-700).
...
export default async function handler(req, res) {
  ...
  const delAuthz = await authorizeGroupAdminEventDelete({ eventId: id, eventTable: 'complex_event', tenantCtx: ctx, req });
