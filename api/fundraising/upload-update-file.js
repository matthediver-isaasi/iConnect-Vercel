...
export default async function handler(req, res) {
  ...
  try {
    ...
    const storagePath = `${tenantContext.tenantId}/fundraising/updates/files/${uniqueId}-${sanitizedName}`;
    ...
    if (error) {
      console.error('[Admin Upload Update File] Upload error:', error);
    ...
    console.error('[Admin Upload Update File] Error:', err);
