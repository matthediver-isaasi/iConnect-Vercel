              ...
              <div className={getGridClass()}>
                {paginatedItems.map((org) => (
                  <DirectoryOrganizationCard
                    ...
                    memberCount={organizationMemberCounts[org.id] || 0}
                    isGuest={isGuest}
                    canEditLogos={canEditLogos}
                    onEditLogo={(e, o) => openEditDialog(e, o)}
                    onRequestDeleteLogo={(o) => { setEditingOrg(o); setShowDeleteConfirm(true); }}
                    onSelect={(o) => { if (hasReverseCardContent) setSelectedOrg(o); }}
                  />
                ))}
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {paginatedItems.map(member => (
                  <DirectoryMemberCard
                    ...
                    organization={allOrganizations.find(o => o.id === member.organization_id)}
                    displaySettings={memberDisplaySettings}
                    directoryCustomFields={directoryCustomFields}
                    memberValues={memberPreferenceMap[member.id] || {}}
                    isGuest={isGuest}
