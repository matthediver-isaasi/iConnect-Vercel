...
const CanvasBuilder = forwardRef(function CanvasBuilder({
  ...
  // Always-current design snapshot for async consumers (e.g. the debounced
  // auto-height commit reads the block's stored height at schedule time to
  // decide whether a measurement is a suspect shrink). Updated during render so
  // it is never stale by the time a ResizeObserver fires.
