...
export default function OrgFieldVisibilityRulesEditor({ 
  ...
  const getAllFields = () => {
    ...
    return [...coreFieldsList, ...customFieldsList, ...relationshipFieldsList];
  };
                            ...
                            {actions.map((action, actionIndex) => (
                              ...
                              >
                                ...
                                {action.target_type === 'relationship' ? (
                                  ...
                                  >
                                    <SelectTrigger className="h-8 flex-1 min-w-[140px]" data-testid={`select-action-relationship-target-${ruleIndex}-${actionIndex}`}>
