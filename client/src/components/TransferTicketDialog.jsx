...
import { Loader2, Search, User, ArrowRight, Check } from "lucide-react";
import { toast } from "sonner";

export default function TransferTicketDialog({ open, onOpenChange, booking, onSuccess }) {
  ...
  const handleSubmit = async () => {
    if (!booking?.id || !selectedMember?.id) return;
