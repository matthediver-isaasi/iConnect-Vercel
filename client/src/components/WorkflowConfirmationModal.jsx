            ...
            <div className="flex-1 min-w-0 space-y-0.5">
              ...
              {action.approval_warning && (
                <div className="flex items-center gap-1.5 mt-1" data-testid={`action-approval-warning-${i}`}>
                  <AlertTriangle className="h-3.5 w-3.5 text-warning dark:text-warning shrink-0" />
                  <span className="text-xs font-medium text-warning dark:text-warning">{action.approval_warning}</span>
                </div>
              )}
