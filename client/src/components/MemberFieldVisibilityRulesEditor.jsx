...
export default function MemberFieldVisibilityRulesEditor({ 
  open, 
  onOpenChange,
  rulesConfig, 
  customFields = [],
  ...
  const getAllFields = () => {
    const coreFieldsList = MEMBER_CORE_FIELDS.map(cf => ({
      id: cf.id,
      label: cf.label,
      type: cf.type,
  ...
  const handleSave = async () => {
    try {
      ...
      toast.success('Member visibility rules saved');
      onOpenChange(false);
    } catch (error) {
      ...
      <DialogContent className="max-w-4xl max-h-[90vh] grid-rows-[auto_minmax(0,1fr)_auto] overflow-hidden">
        <DialogHeader>
          <DialogTitle className="flex items-center gap-2">
            ...
            Member Field Visibility Rules
          </DialogTitle>
          <DialogDescription>
            Define rules to show, hide, or lock (make read-only) member fields and cards based on other field values. Locking is a UI guard for admins editing in this view; it is not enforced server-side.
          </DialogDescription>
        </DialogHeader>
          ...
          <div className="space-y-4 py-4">
            {rules.length === 0 ? (
              <div className="text-center py-12 text-slate-400 border border-dashed border-slate-200 rounded-lg">
                ...
                <p className="text-xs mt-1 mb-4">Add rules to conditionally show or hide member fields based on other field values</p>
                <Button onClick={addRule} size="sm" variant="outline" data-testid="button-add-first-member-rule">
              ...
              <div className="space-y-4">
                {rules.map((rule, ruleIndex) => {
                  ...
                  return (
                    <div 
                      ...
                      data-testid={`member-rule-card-${ruleIndex}`}
                    >
                      <div 
                      ...
                      >
                        ...
                        <Button
                          ...
                          data-testid={`button-delete-member-rule-${ruleIndex}`}
                        >
                            ...
                            <div className="flex items-center gap-2">
                              ...
                              <div className="flex gap-1">
                                <Button
                                  ...
                                  data-testid={`button-member-logic-and-${ruleIndex}`}
                                >
                                  ALL (AND)
                                </Button>
                                <Button
                                  ...
                                  data-testid={`button-member-logic-or-${ruleIndex}`}
                                >
                                  ANY (OR)
                                </Button>
                              </div>
                          ...
                          <div className="space-y-2">
                            <div className="flex items-center justify-between">
                              ...
                              <Button
                                ...
                                data-testid={`button-add-member-condition-${ruleIndex}`}
                              >
                            ...
                            {conditions.map((condition, condIndex) => {
                              ...
                              return (
                                <div 
                                  ...
                                  data-testid={`member-condition-row-${ruleIndex}-${condIndex}`}
                                >
                                  ...
                                  >
                                    <SelectTrigger className="h-8 w-40" data-testid={`select-member-condition-field-${ruleIndex}-${condIndex}`}>
                                  ...
                                  >
                                    <SelectTrigger className="h-8 w-36" data-testid={`select-member-condition-operator-${ruleIndex}-${condIndex}`}>
                                      <SelectValue />
                                    </SelectTrigger>
                                    <SelectContent>
                                      {OPERATORS.map(op => (
                                  ...
                                  {needsValueInput && (
                                    isBooleanField ? (
                                      ...
                                      <Input
                                        ...
                                        data-testid={`input-member-condition-value-${ruleIndex}-${condIndex}`}
                                      />
                                    )
                                  )}
                                  ...
                                  {conditions.length > 1 && (
                                    <Button
                                      ...
                                      data-testid={`button-delete-member-condition-${ruleIndex}-${condIndex}`}
                                    >
                                      <X className="w-3 h-3" />
                                    </Button>
                                  )}
                          ...
                          <div className="space-y-2">
                            <div className="flex items-center justify-between">
                              ...
                              <Button
                                ...
                                data-testid={`button-add-member-action-${ruleIndex}`}
                              >
                                <Plus className="w-3 h-3 mr-1" />
                                Add
                              </Button>
                            ...
                            {actions.map((action, actionIndex) => (
                              <div 
                                ...
                                data-testid={`member-action-row-${ruleIndex}-${actionIndex}`}
                              >
                                ...
                                >
                                  <SelectTrigger className="h-8 w-28" data-testid={`select-member-action-type-${ruleIndex}-${actionIndex}`}>
                                    <SelectValue />
                                  </SelectTrigger>
                                  <SelectContent>
                                ...
                                {(!action.target_type || action.target_type === 'field') ? (
                                  ...
                                  >
                                    <SelectTrigger className="h-8 flex-1 min-w-[140px]" data-testid={`select-member-action-target-${ruleIndex}-${actionIndex}`}>
                                      <SelectValue placeholder="Select field..." />
                                    </SelectTrigger>
                                    <SelectContent>
                                      <div className="px-2 py-1 text-xs font-medium text-slate-500">Core Fields</div>
                                  ...
                                  >
                                    <SelectTrigger className="h-8 flex-1 min-w-[140px]" data-testid={`select-member-action-card-target-${ruleIndex}-${actionIndex}`}>
                                ...
                                {actions.length > 1 && (
                                  <Button
                                    ...
                                    data-testid={`button-delete-member-action-${ruleIndex}-${actionIndex}`}
                                  >
                                    <X className="w-3 h-3" />
                                  </Button>
                                )}
                ...
                <Button
                  ...
                  onClick={addRule}
                  className="w-full"
                  data-testid="button-add-member-rule"
                >
                  <Plus className="w-4 h-4 mr-2" />
                  Add Rule
                </Button>
        ...
        <DialogFooter className="border-t pt-4">
          <Button variant="outline" onClick={handleCancel} data-testid="button-cancel-member-rules">
            Cancel
          </Button>
          <Button onClick={handleSave} disabled={isSaving} data-testid="button-save-member-rules">
            {isSaving ? (
              <>
