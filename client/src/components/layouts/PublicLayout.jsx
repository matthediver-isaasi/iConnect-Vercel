                      ...
                      <div key={item.id}>
                        ...
                        <div className="flex gap-4 flex-wrap">
                          {socialIcons.linkedin?.enabled && socialIcons.linkedin?.url && (
                            <a href={socialIcons.linkedin.url} target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full border border-white/30 flex items-center justify-center hover:bg-white/10 transition-colors">
                          ...
                          {socialIcons.twitter?.enabled && socialIcons.twitter?.url && (
                            <a href={socialIcons.twitter.url} target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full border border-white/30 flex items-center justify-center hover:bg-white/10 transition-colors">
                          ...
                          {socialIcons.facebook?.enabled && socialIcons.facebook?.url && (
                            <a href={socialIcons.facebook.url} target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full border border-white/30 flex items-center justify-center hover:bg-white/10 transition-colors">
                          ...
                          {socialIcons.instagram?.enabled && socialIcons.instagram?.url && (
                            <a href={socialIcons.instagram.url} target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full border border-white/30 flex items-center justify-center hover:bg-white/10 transition-colors">
                          ...
                          {socialIcons.youtube?.enabled && socialIcons.youtube?.url && (
                            <a href={socialIcons.youtube.url} target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full border border-white/30 flex items-center justify-center hover:bg-white/10 transition-colors">
