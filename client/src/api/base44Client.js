...
class EntitiesProxy {
  ...
  get IEditPageFolder() { return this._getEntity('IEditPageFolder'); }
  ...
  get TrainingFundPurchase() { return this._getEntity('TrainingFundPurchase'); }
  ...
  get EventAgendaItem() { return this._getEntity('EventAgendaItem'); }
  get EventCostLine() { return this._getEntity('EventCostLine'); }
  ...
  get ComplexEventSessionCheckin() { return this._getEntity('ComplexEventSessionCheckin'); }
  ...
  get MemberInboxFolder() { return this._getEntity('MemberInboxFolder'); }
  get MemberInboxMessageState() { return this._getEntity('MemberInboxMessageState'); }
}
