...
-   **Membership Payment Form Element:** Integrates a Stripe payment element for outstanding membership fees, supporting auto-submission upon successful payment.
...
-   **Scope Types:** Tiers can be scoped to `organization` or `member`, with member-scoped tiers offering auto-approval and online card payment flags.
