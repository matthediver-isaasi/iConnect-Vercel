...
- No alpha-specific runner exists yet; this gate is currently enforced by the beta invoice reconciliation tooling, not an alpha runner. Invoice lookup must verify exact payment reference, contact ownership, amount, currency and period; invoice numbers alone are not unique. Preserve immutable source evidence and collection holds.
