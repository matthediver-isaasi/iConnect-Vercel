/**
 * Apply the Group Forum (Task #1421) migration to the destination Supabase
 * over the IPv4 pooler (DEST_DATABASE_URL). Idempotent; safe to re-run.
 *
 * Usage:
 *   node scripts/apply-member-group-forum.mjs
 */
...
const MIGRATIONS = [
  'supabase/migrations/20260614_add_member_group_forum.sql',
];
