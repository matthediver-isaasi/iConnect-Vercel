/**
 * Apply the group_event_public audience column migration (Task #1519) to the
 * destination Supabase over the IPv4 pooler (DEST_DATABASE_URL). Idempotent.
 *
 * Usage:
 *   node scripts/apply-event-group-audience.mjs
 */
...
const MIGRATIONS = [
  'supabase/migrations/20260616_add_event_group_audience.sql',
];
