/**
 * Apply the member-group resource-subcategories (Task #1701) migration to the
 * destination Supabase over the IPv4 pooler (DEST_DATABASE_URL). Idempotent;
 * safe to re-run.
 *
 * Usage:
 *   node scripts/apply-member-group-resource-subcategories.mjs
 */
...
const MIGRATIONS = [
  'supabase/migrations/20260623_add_member_group_resource_subcategories.sql',
];
