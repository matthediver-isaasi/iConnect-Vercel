/**
 * Apply the Group Resources (Task #1575) migration to the destination Supabase
 * over the IPv4 pooler (DEST_DATABASE_URL). Idempotent; safe to re-run.
 *
 * Usage:
 *   node scripts/apply-member-group-resources.mjs
 */
...
const MIGRATIONS = [
  'supabase/migrations/20260618_add_member_group_resources.sql',
];
