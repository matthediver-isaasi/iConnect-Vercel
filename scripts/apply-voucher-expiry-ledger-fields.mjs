/**
 * Apply the Task #3116 voucher expiry ledger & allocation metadata migration.
 *
 * Usage:
 *   node scripts/apply-voucher-expiry-ledger-fields.mjs
 */
...
const MIGRATIONS = [
  'supabase/migrations/20260726_add_voucher_expiry_ledger_fields.sql',
];
