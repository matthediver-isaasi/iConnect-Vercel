/**
 * Apply the Group Events (Task #1144) migration to the destination Supabase
 * over the IPv4 pooler (DEST_DATABASE_URL). Idempotent; safe to re-run.
 *
 * Usage:
 *   node scripts/apply-group-events.mjs
 */
...
const MIGRATIONS = [
  'supabase/migrations/20260528_add_member_group_events.sql',
];
