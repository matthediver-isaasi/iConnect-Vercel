/**
 * Apply the guest_writer linkedin_url column migration.
 *
 * Adds a nullable LinkedIn profile URL to guest_writer, set on
 * /GuestWriterManagement and shown on the blog author card. Idempotent.
 *
 * Usage:
 *   node scripts/apply-guest-writer-linkedin-url.mjs
 */
...
const MIGRATIONS = [
  'supabase/migrations/20260603_guest_writer_linkedin_url.sql',
];
