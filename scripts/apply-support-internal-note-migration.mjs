/**
 * Apply the support_ticket_response.is_internal_note migration (Task #3100).
 *
 * Usage:
 *   node scripts/apply-support-internal-note-migration.mjs
 */
...
const MIGRATIONS = [
  'supabase/migrations/20260726_support_ticket_response_internal_note.sql',
];
