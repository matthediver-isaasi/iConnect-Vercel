/**
 * Apply the i_edit_page_folder migration to the destination Supabase
 * over the IPv4 pooler (DEST_DATABASE_URL). Idempotent; safe to re-run.
 *
 * Usage:
 *   node scripts/apply-iedit-page-folders.mjs
 */
...
const MIGRATIONS = [
  'supabase/migrations/20260704_iedit_page_folders.sql',
];
