/**
 * Apply the Leadership Roles (Task #1153) migration to the destination
 * Supabase over the IPv4 pooler (DEST_DATABASE_URL). Idempotent.
 *
 * Usage:
 *   node scripts/apply-member-group-leadership-roles.mjs
 */
...
const MIGRATIONS = [
  'supabase/migrations/20260528_add_member_group_leadership_roles.sql',
];
