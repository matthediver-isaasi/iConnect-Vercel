/**
 * Apply the Task #1167 unlimited-plan migration.
 *
 * Inserts the `unlimited` plan (all quotas null) and moves every existing
 * tenant onto it so no organisation backfilled to `free` is suddenly throttled.
 *
 * Idempotent — safe to re-run.
 *
 * Usage:
 *   node scripts/apply-unlimited-plan-existing-tenants.mjs
 */
...
const MIGRATIONS = [
  'supabase/migrations/20260529_unlimited_plan_existing_tenants.sql',
];
