/**
 * Apply the member_group.role_badge_ids migration (Task #3297).
 *
 * Usage:
 *   node scripts/apply-member-group-role-badge-ids.mjs
 */
...
const MIGRATIONS = [
  'supabase/migrations/20260803_member_group_role_badge_ids.sql',
];
