 ...
 * "Roles allowed to send group emails" list. This removes the dead column.
 * Idempotent.
 *
 * Usage:
 *   node scripts/apply-drop-member-group-ems-enabled-roles.mjs
 */
...
const MIGRATIONS = [
  'supabase/migrations/20260616_drop_member_group_ems_enabled_roles.sql',
];
