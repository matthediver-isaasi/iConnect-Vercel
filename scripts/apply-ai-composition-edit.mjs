/**
 * Apply the AI Composition Phase 2 editing migration (Task #2850).
 *
 * Creates ai_composition_conversation (idempotent DDL) against the DEST
 * (prod) database via the pooler (DEST_DATABASE_URL).
 *
 * Usage:
 *   node scripts/apply-ai-composition-edit.mjs
 */
...
const MIGRATIONS = [
  'supabase/migrations/20260719_ai_composition_edit.sql',
];
