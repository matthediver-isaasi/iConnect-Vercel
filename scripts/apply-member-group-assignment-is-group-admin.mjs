/**
 * Apply the Group Admin flag (Task #1513) migration to the destination
 * Supabase over the IPv4 pooler (DEST_DATABASE_URL). Idempotent.
 *
 * Usage:
 *   node scripts/apply-member-group-assignment-is-group-admin.mjs
 */
...
const MIGRATIONS = [
  'supabase/migrations/20260616_add_member_group_assignment_is_group_admin.sql',
];
