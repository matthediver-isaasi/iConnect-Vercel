/**
 * Apply the Task #3117 voucher monthly snapshot table migration.
 *
 * Usage:
 *   node scripts/apply-voucher-monthly-snapshot.mjs
 */
...
const MIGRATIONS = [
  'supabase/migrations/20260727_add_voucher_monthly_snapshot.sql',
];
