/**
 * Apply the role badge-colour columns migration.
 *
 * Adds `badge_background_colour` and `badge_text_colour` to the role table.
 *
 * Usage:
 *   node scripts/apply-role-badge-colours.mjs
 */
...
const MIGRATIONS = [
  'supabase/migrations/20260625_role_badge_colours.sql',
];
