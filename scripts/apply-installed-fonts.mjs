/**
 * Apply the Task #2549 installed-fonts migration.
 *
 * Creates the `installed_font` table and seeds every existing tenant with the
 * current 16 curated fonts (via a one-time backfill cohort). Idempotent — safe
 * to re-run.
 *
 * Usage:
 *   node scripts/apply-installed-fonts.mjs
 */
...
const MIGRATIONS = [
  'supabase/migrations/20260710_installed_fonts.sql',
];
