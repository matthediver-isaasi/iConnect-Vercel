/**
 * Apply the event-specific sponsor detail migration.
 *
 * Adds the optional `sponsorship_detail` free-text column to
 * `event_sponsor_assignment` so organisers can note what each sponsor is
 * sponsoring for a specific event.
 *
 * Usage:
 *   node scripts/apply-event-sponsor-detail.mjs
 */
...
const MIGRATIONS = [
  'supabase/migrations/20260616_event_sponsor_assignment_detail.sql',
];
