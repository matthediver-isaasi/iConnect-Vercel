/**
 * Apply the article_brief case_study_status column migration.
 *
 * Adds a manual case-study tracking field (none/prepared/submitted) used by
 * the Case Study card on the brief detail page and the Brief Management
 * column + filter. Idempotent.
 *
 * Usage:
 *   node scripts/apply-article-brief-case-study-status.mjs
 */
...
const MIGRATIONS = [
  'supabase/migrations/20260603_article_brief_case_study_status.sql',
];
