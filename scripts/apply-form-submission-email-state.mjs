/**
 * Apply the Task #3190 form_submission.submission_email_state migration.
 *
 * Usage:
 *   node scripts/apply-form-submission-email-state.mjs
 */
...
const MIGRATIONS = [
  'supabase/migrations/20260728_form_submission_email_state.sql',
];
