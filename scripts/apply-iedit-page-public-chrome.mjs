/**
 * Apply the IEditPage public_chrome migration.
 *
 * Adds the i_edit_page.public_chrome column (both | none | header | footer)
 * that controls which public site chrome (header/footer) is rendered for
 * public-layout pages. Idempotent.
 *
 * Usage:
 *   node scripts/apply-iedit-page-public-chrome.mjs
 */
...
const MIGRATIONS = [
  'supabase/migrations/20260624_add_iedit_page_public_chrome.sql',
];
