/**
 * Apply the Stripe monthly-card membership migration (Task #3620).
 *
 * Usage:
 *   node scripts/apply-stripe-monthly-card.mjs
 */
...
const MIGRATIONS = [
  'supabase/migrations/20260817_stripe_monthly_card.sql',
];
