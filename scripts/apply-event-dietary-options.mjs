/**
 * Apply the Task #1250 event dietary / accessibility / allergy options migration.
 *
 * Usage:
 *   node scripts/apply-event-dietary-options.mjs
 */
...
const MIGRATIONS = [
  'supabase/migrations/20260604_event_dietary_accessibility_options.sql',
];
