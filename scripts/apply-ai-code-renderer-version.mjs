/**
 * Apply the AI Design Studio V2 renderer_version migration (Task #2904).
 *
 * Usage:
 *   node scripts/apply-ai-code-renderer-version.mjs
 */
...
const MIGRATIONS = [
  'supabase/migrations/20260720_ai_code_renderer_version.sql',
];
