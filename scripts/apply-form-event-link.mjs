/**
 * Apply the "event-linked forms" migration (Task #1253) to the destination
 * Supabase over the IPv4 pooler (DEST_DATABASE_URL).
 *
 * Adds form.is_event_related, form.related_event_id and
 * form_submission.event_id. Idempotent; safe to re-run.
 *
 * Usage:
 *   node scripts/apply-form-event-link.mjs
 */
...
const MIGRATIONS = [
  'supabase/migrations/20260605_form_event_link.sql',
];
