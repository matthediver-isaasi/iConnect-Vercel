/**
 * Apply the member_group_assignment created_at migration to the destination
 * Supabase over the IPv4 pooler (DEST_DATABASE_URL). Idempotent; safe to re-run.
 *
 * Usage:
 *   node scripts/apply-member-group-assignment-created-at.mjs
 */
...
const MIGRATIONS = [
  'supabase/migrations/20260702_member_group_assignment_created_at.sql',
];
