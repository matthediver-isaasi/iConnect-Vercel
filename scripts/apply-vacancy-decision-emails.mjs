/**
 * Apply the "vacancy approve/decline decision emails" migration (Task #1700) to
 * the destination Supabase over the IPv4 pooler (DEST_DATABASE_URL).
 *
 * Adds member_group.approval_email_template_id / decline_email_template_id and
 * creates the vacancy_decline + vacancy_decision_email tables. Idempotent; safe
 * to re-run.
 *
 * Usage:
 *   node scripts/apply-vacancy-decision-emails.mjs
 */
...
const MIGRATIONS = [
  'supabase/migrations/20260623_vacancy_decision_emails.sql',
];
