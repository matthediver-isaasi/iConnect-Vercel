/**
 * Apply the Task #2219 member inbox favourites migration.
 *
 * Usage:
 *   node scripts/apply-member-inbox-favourite.mjs
 */
...
const MIGRATIONS = [
  'supabase/migrations/20260704_member_inbox_favourite.sql',
];
