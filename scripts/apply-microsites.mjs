/**
 * Apply the Task #2426 tenant microsites migration.
 *
 * Creates the `microsite` table and adds nullable `microsite_id` columns to
 * `navigation_item` and `i_edit_page`. Idempotent — safe to re-run.
 *
 * Usage:
 *   node scripts/apply-microsites.mjs
 */
...
const MIGRATIONS = [
  'supabase/migrations/20260707_microsites.sql',
];
