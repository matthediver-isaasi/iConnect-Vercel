/**
 * Apply the Task #1536 vacancy tables migration to the destination Supabase
 * over the IPv4 pooler (DEST_DATABASE_URL). Idempotent; safe to re-run.
 *
 * Creates the `vacancy` and `vacancy_application` tables for the group vacancy
 * posting + member application feature.
 *
 * Usage:
 *   node scripts/apply-vacancy-tables.mjs
 */
...
const MIGRATIONS = [
  'supabase/migrations/20260617_create_vacancy_tables.sql',
];
