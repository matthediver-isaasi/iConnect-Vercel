/**
 * Apply the "prevent duplicate form submissions by email" migration to
 * the destination Supabase over the IPv4 pooler (DEST_DATABASE_URL).
 *
 * Idempotent; safe to re-run.
 *
 * Usage:
 *   node scripts/apply-form-prevent-duplicate-email.mjs
 */
...
const MIGRATIONS = [
  'supabase/migrations/20260527_add_form_prevent_duplicate_email.sql',
];
