/**
 * Apply the Help Center AI Q&A migration (Task #2257) to the destination
 * Supabase over the IPv4 pooler (DEST_DATABASE_URL).
 *
 * Enables pgvector and creates help_article_chunk + the match RPC. Idempotent.
 *
 * Usage:
 *   node scripts/apply-help-article-chunks.mjs
 */
...
const MIGRATIONS = ['supabase/migrations/20260704_help_article_chunk.sql'];
