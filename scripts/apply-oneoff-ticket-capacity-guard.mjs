/**
 * Apply the Task #1758 count-based ticket availability capacity guard to the
 * destination Supabase.
 *
 * Creates/replaces the check_oneoff_ticket_capacity(...) Postgres function used
 * by the one-off (standard) event booking path to atomically guard ticket-class
 ...
 *
 * Usage:
 *   node scripts/apply-oneoff-ticket-capacity-guard.mjs
 */
...
const MIGRATIONS = [
  'supabase/migrations/20260623_oneoff_ticket_capacity_guard.sql',
];
