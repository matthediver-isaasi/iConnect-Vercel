/**
 * Apply the Task #1131 membership_invoice_pdf_token migration.
 *
 * Usage:
 *   node scripts/apply-membership-invoice-pdf-token.mjs
 */
...
const MIGRATIONS = [
  'supabase/migrations/20260528_membership_invoice_pdf_token.sql',
];
