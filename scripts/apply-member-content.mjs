/**
 * Apply the Member AI Knowledge Assistant migration (Task #2363) to the
 * destination Supabase over the IPv4 pooler (DEST_DATABASE_URL).
 *
 * Creates member_content_chunk + indexes + match RPC. Idempotent; safe to re-run.
 *
 * Usage:
 *   node scripts/apply-member-content.mjs
 */
