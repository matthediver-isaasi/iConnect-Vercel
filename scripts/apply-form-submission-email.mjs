/**
 * Apply the "reply email from form submissions" migration (Task #1266) to the
 * destination Supabase over the IPv4 pooler (DEST_DATABASE_URL).
 *
 * Creates the form_submission_email table + indexes. Idempotent; safe to
 * re-run.
 *
 * Usage:
 *   node scripts/apply-form-submission-email.mjs
 */
...
const MIGRATIONS = [
  'supabase/migrations/20260607_form_submission_email.sql',
];
