/**
 * Apply the member_group_guest.member_id column migration.
 *
 * Adds a nullable `member_id` UUID FK to member_group_guest so newly-provisioned
 * guests are linked to a real member record. Legacy rows are left as-is (NULL).
 *
 * Usage:
 *   node scripts/apply-member-group-guest-member-id.mjs
 */
...
const MIGRATIONS = [
  'supabase/migrations/20260701_member_group_guest_member_id.sql',
];
