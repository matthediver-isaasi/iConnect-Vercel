/**
 * Apply the form `owners` column migration.
 *
 * Adds an `owners` UUID[] column (default '{}') to form so admins can assign
 * members as owners of a form. Owners see a scoped "My Forms" tab on the
 * FormSubmissions page. Idempotent.
 *
 * Usage:
 *   node scripts/apply-form-owners.mjs
 */
...
const MIGRATIONS = [
  'supabase/migrations/20260614_form_owners.sql',
];
