/**
 * Apply the Task #2525 microsite branding_config migration.
 *
 * Adds a `branding_config` jsonb column to `microsite` for per-microsite
 * branding overrides. Idempotent — safe to re-run.
 *
 * Usage:
 *   node scripts/apply-microsite-branding-config.mjs
 */
...
const MIGRATIONS = [
  'supabase/migrations/20260709_microsite_branding_config.sql',
];
