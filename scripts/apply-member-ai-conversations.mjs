/**
 * Apply the Task #2407 member AI conversation history migration.
 *
 * Creates member_ai_conversation + member_ai_message (idempotent DDL) against
 * the DEST (prod) database via the pooler (DEST_DATABASE_URL).
 *
 * Usage:
 *   node scripts/apply-member-ai-conversations.mjs
 */
...
const MIGRATIONS = [
  'supabase/migrations/20260707_member_ai_conversation.sql',
];
