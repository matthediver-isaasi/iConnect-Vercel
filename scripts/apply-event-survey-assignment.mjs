/**
 * Apply the Task #3331 event survey assignment migration (DEST db).
 *
 * Usage:
 *   DEST_DATABASE_URL=... node scripts/apply-event-survey-assignment.mjs
 */
...
const MIGRATIONS = [
  'supabase/migrations/20260804_event_survey_assignment.sql',
];
