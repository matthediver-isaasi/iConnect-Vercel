/**
 * Apply the Task #1269 guest-approval-token migration.
 *
 * Creates the `guest_approval_token` table that backs the tokenised
 * Approve/Deny links emailed to tenant roles when a guest member signs up.
 *
 * Idempotent — safe to re-run (CREATE TABLE/INDEX IF NOT EXISTS).
 *
 * Usage:
 *   node scripts/apply-guest-approval-token.mjs
 */
...
const MIGRATIONS = [
  'supabase/migrations/20260607_guest_approval_token.sql',
];
