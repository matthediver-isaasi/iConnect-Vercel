/**
 * Apply the Task #1242 member group classification migration.
 *
 * Usage:
 *   node scripts/apply-member-group-classification.mjs
 */
...
const MIGRATIONS = [
  'supabase/migrations/20260603_member_group_classification.sql',
];
