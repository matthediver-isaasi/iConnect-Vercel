/**
 * Apply the GoCardless Phase 4 (failure handling, refunds, finance & admin
 * console) migration to the destination Supabase.
 *
 * Runs supabase/migrations/20260728_gocardless_phase4_finance.sql in a
 * single transaction over the IPv4 pooler (DEST_DATABASE_URL). The file is
 * idempotent, so re-running this script is safe.
 *
 * Usage:
 *   node scripts/apply-gocardless-phase4.mjs
 */
...
const MIGRATIONS = [
  'supabase/migrations/20260728_gocardless_phase4_finance.sql',
];
