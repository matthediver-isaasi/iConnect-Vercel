/**
 * Apply the Task #3392 migration:
 *   - team_member_invitation table (tokenised team invite signup flow)
 *
 * Idempotent — safe to re-run (CREATE TABLE IF NOT EXISTS).
 *
 * Usage:
 *   node scripts/apply-team-member-invitations.mjs
 */
...
const MIGRATIONS = [
  'supabase/migrations/20260804_team_member_invitation.sql',
];
