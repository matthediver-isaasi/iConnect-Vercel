/**
 * Apply the "Invoice Now" (advance org membership invoicing) migration.
 *
 * Adds organisation_membership_history.scheduled_activation_date.
 *
 * Usage:
 *   node scripts/apply-membership-advance-invoice.mjs
 */
...
const MIGRATIONS = [
  'supabase/migrations/20260611_membership_advance_invoice.sql',
];
