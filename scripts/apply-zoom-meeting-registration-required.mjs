/**
 * Apply the zoom_meeting.registration_required migration (Task #2819).
 *
 * Usage:
 *   node scripts/apply-zoom-meeting-registration-required.mjs
 */
...
const MIGRATIONS = [
  'supabase/migrations/20260715_zoom_meeting_registration_required.sql',
];
