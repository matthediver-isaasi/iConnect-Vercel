/**
 * Apply the Task #3483 form_submission payment columns migration.
 *
 * Usage:
 *   node scripts/apply-form-submission-payment.mjs
 */
...
const MIGRATIONS = [
  'supabase/migrations/20260810_form_submission_payment.sql',
];
