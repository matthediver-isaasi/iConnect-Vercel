/**
 * Apply the Task #1243 member group classification unique-name migration.
 *
 * Merges any pre-existing duplicate classification names (case-insensitive,
 * per tenant) and adds a tenant-scoped unique index. Idempotent.
 *
 * Usage:
 *   node scripts/apply-member-group-classification-unique-name.mjs
 */
...
const MIGRATIONS = [
  'supabase/migrations/20260603_member_group_classification_unique_name.sql',
];
