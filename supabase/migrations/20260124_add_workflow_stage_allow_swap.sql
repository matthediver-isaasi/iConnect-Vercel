...
-- This migration updates existing form_due_diligence_config records to add allow_swap: true
...
UPDATE form_due_diligence_config
SET workflow_stages = (
  SELECT jsonb_agg(
    CASE 
...
COMMENT ON COLUMN form_due_diligence_config.workflow_stages IS 'Array of workflow stages. Each stage can have allow_swap (boolean, default true) to control whether form swapping is permitted at that stage.';
